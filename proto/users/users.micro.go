...
func (c *userService) DeleteUser(ctx context.Context, in *User, opts ...client.CallOption) (*Response, error) {
...
func (c *userService) GetUserByPersonID(ctx context.Context, in *User, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserService.GetUserByPersonID", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *userService) GetUserByPersonIDAndPassword(ctx context.Context, in *User, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserService.GetUserByPersonIDAndPassword", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *userServiceHandler) DeleteUser(ctx context.Context, in *User, out *Response) error {
	return h.UserServiceHandler.DeleteUser(ctx, in, out)
}

func (h *userServiceHandler) GetUserByPersonID(ctx context.Context, in *User, out *Response) error {
	return h.UserServiceHandler.GetUserByPersonID(ctx, in, out)
}

func (h *userServiceHandler) GetUserByPersonIDAndPassword(ctx context.Context, in *User, out *Response) error {
	return h.UserServiceHandler.GetUserByPersonIDAndPassword(ctx, in, out)
}
